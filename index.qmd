...
```{r scatterplot1, echo=TRUE, message=FALSE, warning=FALSE, comment="", tidy=TRUE}
library("ggplot2")
library("readxl")
library("dplyr")
ggplot(data=dat,aes(x=pdrb,y=tpt)) +
  geom_point(color="blue",size=2) + # setiap nambah command, selalu kasih tanda +
  labs(title="tabel 1. hubungan antara Pertumbuhan PDRB dan Tingkat Pengangguran Terbuka 2020",
       x="Pertumbuhan PDRB Provinsi 2020",
       y="Tingkat Pengangguran Terbuka 2020",
       caption = "sumber: Badan Pusat Statistik") +
  theme_classic()
```

Baca data hubungan antara Pertumbuhan PDRB dan Tingkat Partisipasi Angkatan Kerja 2020
...
ggplot(data=dat,aes(x=pdrb,y=tpak)) +
  ...
  labs(title="tabel 1. hubungan antara Pertumbuhan PDRB dan Tingkat Partisipasi Angkatan Kerja 2020",
       x="Pertumbuhan PDRB Provinsi 2020",
       y="Tingkat Partisipasi Angkatan Kerja 2020",
       caption = "sumber: Badan Pusat Statistik") +
  theme_classic()
```
